...
export default function MarketplaceDetailError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    console.error('[MarketplaceDetail Error]', {
    ...
    <div className="flex items-center justify-center p-8 min-h-[60vh]">
      <Card className="max-w-lg w-full">
        ...
        <CardFooter className="flex gap-2 justify-center">
          ...
          <Button onClick={() => (window.location.href = '/admin/marketplace')} variant="outline">
