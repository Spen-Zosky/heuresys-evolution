...
test_1.test.describe('Manual Verification — Login Rotation', () => {
    ...
    (0, test_1.test)('1. rtl-admin: dashboard con dipendenti', async ({ page }) => {
        await loginAs(page, 'rtl-admin', 'Admin2026');
        // Should be on /admin
        (0, test_1.expect)(page.url()).toContain('/admin');
        ...
        await (0, test_1.expect)(headcountCard).toBeVisible({ timeout: 10000 });
    ...
    (0, test_1.test)('2. sysadmin: platform pages e switch tenant', async ({ page }) => {
        await loginAs(page, 'sysadmin', 'Admin2026');
        console.log('=== SYSADMIN PLATFORM ===');
        console.log('URL:', page.url());
        (0, test_1.expect)(page.url()).toContain('/platform');
...
//# sourceMappingURL=manual-verification.spec.js.map