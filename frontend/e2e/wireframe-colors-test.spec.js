 ...
 */
test_1.test.describe('Wireframe Viewer', () => {
    (0, test_1.test)('verify wireframe renders correctly', async ({ page }) => {
        ...
        // Assertions
        (0, test_1.expect)(canvasInfo.hasExcalidraw).toBe(true);
        (0, test_1.expect)(canvasInfo.hasCanvas).toBe(true);
        (0, test_1.expect)(canvasInfo.canvasWidth).toBeGreaterThan(0);
        (0, test_1.expect)(canvasInfo.canvasHeight).toBeGreaterThan(0);
    });
});
//# sourceMappingURL=wireframe-colors-test.spec.js.map