...
test_1.test.describe('AI Career Coach Module', () => {
    test_1.test.use({ storageState: '.auth/admin.json' });
    test_1.test.describe('Career Dashboard', () => {
        (0, test_1.test)('should display career dashboard with all sections', async ({ page }) => {
        ...
        (0, test_1.test)('should show quick actions on dashboard', async ({ page }) => {
            await page.goto('/admin/career');
            await page.waitForLoadState('domcontentloaded');
        ...
        (0, test_1.test)('should navigate to sub-pages from dashboard', async ({ page }) => {
            await page.goto('/admin/career');
            // Click on skill assessment link
            await page.getByRole('link', { name: /Skill Assessment/i }).click();
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/skills/);
        });
    });
    test_1.test.describe('Skill Gap Analysis', () => {
        (0, test_1.test)('should display skill gap analysis page', async ({ page }) => {
        ...
        (0, test_1.test)('should filter skills by priority', async ({ page }) => {
            await page.goto('/admin/career/skills');
            await page.waitForLoadState('domcontentloaded');
        ...
        (0, test_1.test)('should display skill cards', async ({ page }) => {
            await page.goto('/admin/career/skills');
            await page.waitForLoadState('domcontentloaded');
            // Verify some content is displayed
            await (0, test_1.expect)(page.locator('main')).toBeVisible();
        });
        (0, test_1.test)('should show charts', async ({ page }) => {
            await page.goto('/admin/career/skills');
            await page.waitForLoadState('domcontentloaded');
    ...
    test_1.test.describe('Career Path Visualization', () => {
        (0, test_1.test)('should display career paths page', async ({ page }) => {
            await page.goto('/admin/career/paths');
            // Verify page header
            await (0, test_1.expect)(page.getByRole('heading').first()).toBeVisible();
        });
        (0, test_1.test)('should show career path cards with match scores', async ({ page }) => {
            await page.goto('/admin/career/paths');
            await page.waitForLoadState('domcontentloaded');
            await page.waitForLoadState('networkidle');
        ...
        (0, test_1.test)('should have expandable career paths', async ({ page }) => {
            await page.goto('/admin/career/paths');
            await page.waitForLoadState('domcontentloaded');
    ...
    test_1.test.describe('Learning Recommendations', () => {
        (0, test_1.test)('should display learning recommendations page', async ({ page }) => {
            await page.goto('/admin/career/learning');
            // Verify page loads — heading appears after API call completes
            await (0, test_1.expect)(page.getByRole('heading').first()).toBeVisible({ timeout: 30000 });
        });
        (0, test_1.test)('should filter learning items by type', async ({ page }) => {
            await page.goto('/admin/career/learning');
            await page.waitForLoadState('domcontentloaded');
            const filterButton = page.getByRole('combobox').first();
            if (await filterButton.isVisible({ timeout: 3000 })) {
        ...
        (0, test_1.test)('should show learning item cards with relevance', async ({ page }) => {
            await page.goto('/admin/career/learning');
            await page.waitForLoadState('domcontentloaded');
    ...
    test_1.test.describe('Mentorship Matching', () => {
        (0, test_1.test)('should display mentorship matching page', async ({ page }) => {
            await page.goto('/admin/career/mentors');
            // Verify page header
            await (0, test_1.expect)(page.getByRole('heading').first()).toBeVisible();
        });
        (0, test_1.test)('should show mentor cards with match scores', async ({ page }) => {
            await page.goto('/admin/career/mentors');
            await page.waitForLoadState('domcontentloaded');
            await page.waitForLoadState('networkidle');
        ...
        (0, test_1.test)('should show mentor availability status', async ({ page }) => {
            await page.goto('/admin/career/mentors');
            await page.waitForLoadState('domcontentloaded');
            await page.waitForLoadState('networkidle');
    ...
    test_1.test.describe('Career Goals Tracker', () => {
        (0, test_1.test)('should display goals tracker page', async ({ page }) => {
            await page.goto('/admin/career/goals');
            await page.waitForLoadState('domcontentloaded');
            // Page heading is "Obiettivi di Carriera" (Italian) — match either Italian or English
            await (0, test_1.expect)(page.getByRole('heading', { name: /obiettiv|goal|carriera/i }).first()).toBeVisible();
        });
        (0, test_1.test)('should show goal cards with progress', async ({ page }) => {
            await page.goto('/admin/career/goals');
            // Verify progress indicators - look for "Progress" text or percentage in main area
            await (0, test_1.expect)(page.locator('main').getByText('Progress').first()).toBeVisible();
        });
        (0, test_1.test)('should filter goals by category', async ({ page }) => {
            await page.goto('/admin/career/goals');
            await page.waitForLoadState('domcontentloaded');
            const filterButton = page.getByRole('combobox').first();
            if (await filterButton.isVisible({ timeout: 3000 })) {
        ...
        (0, test_1.test)('should expand goal to show milestones', async ({ page }) => {
            await page.goto('/admin/career/goals');
            await page.waitForLoadState('domcontentloaded');
            ...
            if (await goalCard.isVisible({ timeout: 3000 })) {
                ...
                await (0, test_1.expect)(page.getByText(/milestone/i).first()).toBeVisible({ timeout: 5000 });
            }
        });
        (0, test_1.test)('should switch between goal tabs', async ({ page }) => {
            await page.goto('/admin/career/goals');
            // Click on completed tab
            const completedTab = page.getByRole('tab', { name: /completed/i });
            if (await completedTab.isVisible({ timeout: 3000 })) {
                await completedTab.click();
                await (0, test_1.expect)(page.getByRole('tabpanel')).toBeVisible();
            }
        });
    });
    test_1.test.describe('AI Career Chat', () => {
        (0, test_1.test)('should display AI career chat page', async ({ page }) => {
            await page.goto('/admin/career/chat');
            // Verify chat interface - main heading "AI Career Coach"
            await (0, test_1.expect)(page.getByRole('heading', { level: 1 })).toBeVisible();
        });
        (0, test_1.test)('should show quick action buttons', async ({ page }) => {
            await page.goto('/admin/career/chat');
            // Verify quick actions (Italian UI)
            await (0, test_1.expect)(page.getByText(/Percorso Carriera|Gap Competenze|Piano Formativo/i).first()).toBeVisible();
        });
        (0, test_1.test)('should have message input', async ({ page }) => {
            await page.goto('/admin/career/chat');
        ...
        (0, test_1.test)('should send a message', async ({ page }) => {
            await page.goto('/admin/career/chat');
            // Find input field — placeholder is "Scrivi un messaggio..." (Italian)
            const input = page.getByPlaceholder(/scrivi|messaggio|message|ask|career/i);
            ...
            await (0, test_1.expect)(page.getByText('What career paths suit me?')).toBeVisible();
        });
    });
    test_1.test.describe('Career Insights Reports', () => {
        (0, test_1.test)('should display reports page', async ({ page }) => {
            await page.goto('/admin/career/reports');
            // Verify page header — actual heading is "Report Carriera" (Italian)
            await (0, test_1.expect)(page.getByRole('heading', { name: /report|career|carriera/i }).first()).toBeVisible({ timeout: 30000 });
        });
        (0, test_1.test)('should show report cards', async ({ page }) => {
            await page.goto('/admin/career/reports');
            // Wait for page to load (heading appears after API call)
            await (0, test_1.expect)(page.getByRole('heading', { name: /report|carriera/i }).first()).toBeVisible({ timeout: 30000 });
            ...
            await (0, test_1.expect)(reportContent).toBeVisible();
        });
        (0, test_1.test)('should display charts on reports page', async ({ page }) => {
            await page.goto('/admin/career/reports');
        ...
        (0, test_1.test)('should have download options', async ({ page }) => {
            await page.goto('/admin/career/reports');
            // Wait for page to load — heading appears after API call completes
            const headingVisible = await page.getByRole('heading', { name: /report|carriera/i }).first()
                .isVisible({ timeout: 30000 }).catch(() => false);
    ...
    test_1.test.describe('Navigation', () => {
        (0, test_1.test)('should navigate between all career pages', async ({ page }) => {
            // Dashboard
            await page.goto('/admin/career');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career$/);
            // Skills
            await page.goto('/admin/career/skills');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/skills/);
            // Paths
            await page.goto('/admin/career/paths');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/paths/);
            // Learning
            await page.goto('/admin/career/learning');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/learning/);
            // Mentors
            await page.goto('/admin/career/mentors');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/mentors/);
            // Goals
            await page.goto('/admin/career/goals');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/goals/);
            // Chat
            await page.goto('/admin/career/chat');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/chat/);
            // Reports
            await page.goto('/admin/career/reports');
            await (0, test_1.expect)(page).toHaveURL(/\/admin\/career\/reports/);
        });
    });
    test_1.test.describe('Responsive Design', () => {
        ...
        (0, test_1.test)('should be responsive on tablet viewport', async ({ page }) => {
...
//# sourceMappingURL=career-coach.spec.js.map