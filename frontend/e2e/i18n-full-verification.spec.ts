...
// ============================================================
test('T1: Root page loads without 404', async ({ page }) => {
...
// ============================================================
test('T2: Login page loads', async ({ page }) => {
...
// ============================================================
test('T3: Login page in Italian', async ({ page }) => {
...
// ============================================================
test('T4: Login page in English', async ({ page }) => {
...
// ============================================================
test('T5: Portal workspace loads after login', async ({ page }) => {
  await login(page);
...
// ============================================================
test('T6: Portal profile loads', async ({ page }) => {
  await login(page);
...
// ============================================================
test('T7: Admin employees page loads', async ({ page }) => {
  await login(page);
...
// ============================================================
test('T8: Platform tenants page loads', async ({ page }) => {
  await login(page);
...
// ============================================================
test('T9: API health and bilingual data', async ({ request }) => {
  // Health check
...
// ============================================================
test('T10: Language switcher component visible', async ({ page }) => {
  await login(page);
  await page.goto(`${BASE}/portal/workspace`);
  await page.waitForLoadState('networkidle');
...
// ============================================================
test('T11: Switching locale cookie changes portal content', async ({ page }) => {
  await login(page);
  ...
  expect(bodyIT.length).toBeGreaterThan(100);
  expect(bodyEN.length).toBeGreaterThan(100);
});

// ============================================================
// TEST 12: Public landing page with locale URL prefix
// ============================================================
test('T12: /it/landing loads Italian landing page', async ({ page }) => {
...
test('T13: /en/landing loads English landing page', async ({ page }) => {
...
// ============================================================
test('T14: /403 page loads', async ({ page }) => {
...
for (const path of portalPages) {
  test(`T15: ${path} loads`, async ({ page }) => {
    await login(page);
