...
test.describe('AI Services Re-Audit', () => {

  test('BUG-030: AI Chat page loads sessions list (no 404)', async ({ page }) => {
  ...
  test('BUG-032/033: AI Documents page shows filename and chunk_count', async ({ page }) => {
  ...
  test('BUG-036/037/038: AI Sessions page shows real data columns', async ({ page }) => {
  ...
  test('BUG-035: AI Documents upload button exists with handler', async ({ page }) => {
    await page.goto('/admin/ai/documents', { waitUntil: 'networkidle' });
    await page.waitForTimeout(3000);
