...
test_1.test.describe('Analytics Re-Audit', () => {
    test_1.test.beforeEach(async ({ page }) => {
        await loginViaAPI(page);
    });
    (0, test_1.test)('BUG-014: /admin/analytics — employeeChange and absenceRate not hardcoded 0', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-015: /admin/analytics — AI stat accuracy not hardcoded 87%', async ({ page }) => {
        await page.goto('/admin/analytics');
        await page.waitForLoadState('networkidle');
        await page.waitForTimeout(2000);
        const pageContent = await page.textContent('body') || '';
    ...
    (0, test_1.test)('BUG-016: /admin/analytics/workforce — charts show data', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-017: /admin/analytics/compensation — data not all zeros', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-019: /admin/analytics/ai — loads without 404', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-020: /admin/analytics/predictions — endpoint responds', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-021: /admin/analytics/hr-intelligence — loads', async ({ page }) => {
...
//# sourceMappingURL=re-audit-analytics.spec.js.map