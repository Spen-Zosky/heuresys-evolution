...
test.describe('Re-Audit Regressions', () => {
  test.beforeEach(async ({ page }) => {
    await loginAsSysadmin(page)
  })

  test('Regression: Compensation section loads (was 8.3/10)', async ({ page }) => {
  ...
  test('Regression: Recruiting section loads (was 8.2/10)', async ({ page }) => {
  ...
  test('Regression: Admin Dashboard loads with data (was 8.0/10)', async ({ page }) => {
  ...
  test('Regression: Compliance section loads (was 7.0/10)', async ({ page }) => {
  ...
  test('Regression: Engagement Wellbeing loads', async ({ page }) => {
