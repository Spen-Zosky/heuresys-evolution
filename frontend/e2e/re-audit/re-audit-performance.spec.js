...
test_1.test.describe('Performance Re-Audit', () => {
    (0, test_1.test)('BUG-090: OKRs page shows table with data columns', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-103a: Continuous feedback page loads without 501', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-103b: 360 reviews page loads without 501', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-091: Review cycles page shows badge types correctly', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-092: Calibration page shows data columns', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-102: Check-ins page shows meeting_type', async ({ page }) => {
...
//# sourceMappingURL=re-audit-performance.spec.js.map