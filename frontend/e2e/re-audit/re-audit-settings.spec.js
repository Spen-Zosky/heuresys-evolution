...
test_1.test.describe('Re-Audit Settings', () => {
    test_1.test.beforeEach(async ({ page }) => {
        await (0, login_helper_1.loginAsSysadmin)(page);
    });
    (0, test_1.test)('BUG-127: /admin/settings loads tenant configuration', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-128: /admin/settings/notifications - save works', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-131: /admin/settings/tenant-setup - save calls API', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-129: /admin/settings/sap-migration - status loads', async ({ page }) => {
...
//# sourceMappingURL=re-audit-settings.spec.js.map