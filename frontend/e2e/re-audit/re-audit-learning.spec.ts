...
test.describe('Re-Audit Learning', () => {
  test.beforeEach(async ({ page }) => {
    await loginAsSysadmin(page)
  })

  test('BUG-104: skills page shows preferred_label_en', async ({ page }) => {
  ...
  test('BUG-105: certifications page shows issuing_organization', async ({ page }) => {
  ...
  test('BUG-097: courses page - badge status correct (not all "Inattivo")', async ({ page }) => {
  ...
  test('BUG-096: learning paths - columns correct', async ({ page }) => {
  ...
  test('BUG-099: courses/new - code field present, create works', async ({ page }) => {
