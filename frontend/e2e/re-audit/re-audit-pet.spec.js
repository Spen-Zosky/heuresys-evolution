...
test_1.test.describe('Company PET Re-Audit', () => {
    test_1.test.beforeEach(async ({ page }) => {
        await loginViaAPI(page);
    });
    (0, test_1.test)('BUG-050: Company PET pages — KPI cards show data', async ({ page }) => {
        const petPages = [
    ...
    (0, test_1.test)('BUG-053: Company PET sessions — list loads', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-054: Company PET staging/org-scenarios — list loads', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-056: Workforce demographics — data present', async ({ page }) => {
    ...
    (0, test_1.test)('BUG-055: 9-box and rating distribution — real data (not mock)', async ({ page }) => {
...
//# sourceMappingURL=re-audit-pet.spec.js.map