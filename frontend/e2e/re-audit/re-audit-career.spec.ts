...
test.describe('Career Re-Audit', () => {
  test.beforeEach(async ({ page }) => {
    await loginViaAPI(page);
  });

  test('BUG-040/117: /admin/career/chat — chat works (no 404)', async ({ page }) => {
  ...
  test('BUG-116: /admin/career — "+12%" replaced with N/D or computed', async ({ page }) => {
  ...
  test('BUG-119: /admin/career/learning — data not hardcoded', async ({ page }) => {
  ...
  test('BUG-121: /admin/career/mentors — data not hardcoded', async ({ page }) => {
  ...
  test('BUG-122: /admin/career/paths — visualization from API', async ({ page }) => {
  ...
  test('BUG-123: /admin/career/reports — analytics endpoints respond', async ({ page }) => {
