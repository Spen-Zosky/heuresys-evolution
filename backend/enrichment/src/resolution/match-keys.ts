 ...
 */
export function deriveWebsiteDomain(value: unknown): string | null {
 ...
 */
function canonicalise(key: string, value: unknown): string | null {
  ...
  if (/vat|tax_id|country/i.test(key)) return trimmed.toUpperCase();
