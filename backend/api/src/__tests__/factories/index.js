 ...
 */
export function buildEmployeeList(count, overrides = {}) {
...
export function buildDepartment(overrides = {}) {
...
export function buildGoal(overrides = {}) {
...
export function buildSysadminTokenPayload(overrides = {}) {
    return {
        userId: 'user-uuid-1',
        username: 'sysadmin',
        role: 'SYSADMIN',
 ...
 */
export function buildSuperuserTokenPayload(overrides = {}) {
    return {
        userId: 'user-uuid-0',
        username: 'superuser',
        role: 'SUPERUSER',
...
export function buildAdminTokenPayload(overrides = {}) {
    return {
        userId: 'user-uuid-2',
        username: 'admin',
        role: 'ADMIN',
...
export function buildEmployeeTokenPayload(overrides = {}) {
    return {
        userId: 'user-uuid-3',
        username: 'employee',
        role: 'EMPLOYEE',
