...
import { securityMiddleware, additionalSecurityHeaders, helmetConfig, } from '../../middleware/security.js';
describe('Security Middleware', () => {
    ...
    describe('additionalSecurityHeaders', () => {
        ...
        it('should set Permissions-Policy header', () => {
            ...
            expect(mockSetHeader).toHaveBeenCalledWith('Permissions-Policy', expect.stringContaining('camera=()'));
        });
