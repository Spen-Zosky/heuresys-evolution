...
const mockLoadApiKeyFromDb = jest.fn().mockResolvedValue(true as never);
...
const mockCrossLoadApiKey = jest.fn().mockResolvedValue(true as never);
...
function createTestApp(): Express {
  ...
  app.use('/api/v1/ontology', (req, _res, next) => {
    (req as { tenantId?: string }).tenantId = UUID_1;
