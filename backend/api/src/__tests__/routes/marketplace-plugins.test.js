...
import { buildSuperuserTokenPayload } from '../factories/index.js';
// ---------------------------------------------------------------------------
...
describe('Marketplace Plugins Routes - Behavioral Tests', () => {
    ...
    describe('POST /api/v1/marketplace/plugins/:id/versions', () => {
        it('should create a new version for a plugin', async () => {
            // Plugin exists
            mockQuery.mockResolvedValueOnce({ rows: [{ id: PLUGIN_UUID }], rowCount: 1 });
    ...
    describe('POST /api/v1/marketplace/plugins/:id/dependencies', () => {
        it('should add a dependency to a plugin', async () => {
            ...
            mockQuery.mockResolvedValueOnce({ rows: [{ id: DEP_PLUGIN_UUID }], rowCount: 1 });
            // INSERT dependency
            mockQuery.mockResolvedValueOnce({
                rows: [
                    {
...
//# sourceMappingURL=marketplace-plugins.test.js.map