...
describe('Inference Review Routes', () => {
    ...
    describe('GET /pending', () => {
        ...
        it('should apply custom limit, offset, relationType, and minConfidence', async () => {
            ...
            const res = await supertest(app).get('/api/v1/inference/pending?limit=5&offset=10&relationType=related&minConfidence=0.7&sortBy=date_desc');
            expect(res.status).toBe(200);
...
//# sourceMappingURL=inference-review.test.js.map