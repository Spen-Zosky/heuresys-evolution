...
describe('Calibration Sessions Routes', () => {
  ...
  beforeEach(() => {
    jest.resetAllMocks();
    resetFactories();
    mockConnect.mockResolvedValue({ query: mockClientQuery, release: mockClientRelease } as never);
    app = createTestApp();
  ...
  describe('DELETE /calibration-sessions/:id/participants/:participantId', () => {
    it('should remove a participant', async () => {
      ...
      const res = await supertest(app)
        .delete(
          '/api/v1/calibration-sessions/22222222-2222-2222-2222-222222222222/participants/p-1'
        )
        .set('Authorization', `Bearer ${token}`);
    ...
    it('should return 404 when participant not found', async () => {
      ...
      const res = await supertest(app)
        .delete(
          '/api/v1/calibration-sessions/22222222-2222-2222-2222-222222222222/participants/nonexistent'
        )
        .set('Authorization', `Bearer ${token}`);
  ...
  describe('GET /calibration-sessions/:id/outliers', () => {
    ...
    it('should accept custom threshold', async () => {
      ...
      const res = await supertest(app)
        .get(
          '/api/v1/calibration-sessions/22222222-2222-2222-2222-222222222222/outliers?threshold=1.5'
        )
        .set('Authorization', `Bearer ${token}`);
  ...
  describe('PATCH /calibration-sessions/:id/adjustments/:adjustmentId/notes', () => {
    it('should update discussion notes', async () => {
      ...
      const res = await supertest(app)
        .patch(
          '/api/v1/calibration-sessions/22222222-2222-2222-2222-222222222222/adjustments/adj-1/notes'
        )
        .set('Authorization', `Bearer ${token}`)
    ...
    it('should return 404 when adjustment not found', async () => {
      ...
      const res = await supertest(app)
        .patch(
          '/api/v1/calibration-sessions/22222222-2222-2222-2222-222222222222/adjustments/nonexistent/notes'
        )
        .set('Authorization', `Bearer ${token}`)
  ...
  describe('PATCH /calibration-sessions/:id/adjustments/:adjustmentId', () => {
    it('should update an adjustment', async () => {
      ...
      const res = await supertest(app)
        .patch(
          '/api/v1/calibration-sessions/22222222-2222-2222-2222-222222222222/adjustments/adj-1'
        )
        .set('Authorization', `Bearer ${token}`)
    ...
    it('should return 404 when adjustment not found', async () => {
      ...
      const res = await supertest(app)
        .patch(
          '/api/v1/calibration-sessions/22222222-2222-2222-2222-222222222222/adjustments/nonexistent'
        )
        .set('Authorization', `Bearer ${token}`)
