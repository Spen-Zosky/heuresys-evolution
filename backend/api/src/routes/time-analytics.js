 ...
 */
router.get('/attendance-patterns', validate(timeAnalyticsPeriodQuerySchema, 'query'), asyncHandler(async (req, res) => {
    const tenantId = getTenantIdOrThrow(req);
    const dbClient = req.dbClient;
 ...
 */
router.get('/overtime', validate(timeAnalyticsPeriodQuerySchema, 'query'), asyncHandler(async (req, res) => {
    const tenantId = getTenantIdOrThrow(req);
    const dbClient = req.dbClient;
    const days = req.query.period;
    // Overtime summary
 ...
 */
router.get('/hours-distribution', asyncHandler(async (req, res) => {
    const tenantId = getTenantIdOrThrow(req);
    const dbClient = req.dbClient;
 ...
 */
router.get('/remote-work', asyncHandler(async (req, res) => {
    const tenantId = getTenantIdOrThrow(req);
    const dbClient = req.dbClient;
 ...
 */
router.get('/absenteeism', asyncHandler(async (req, res) => {
    const tenantId = getTenantIdOrThrow(req);
    const dbClient = req.dbClient;
...
//# sourceMappingURL=time-analytics.js.map