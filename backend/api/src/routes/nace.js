...
router.get('/sections', asyncHandler(async (req, res) => {
    ...
    const data = await cached('nace:sections', async () => {
 ...
 */
router.get('/divisions', validate(naceDivisionsQuerySchema, 'query'), asyncHandler(async (req, res) => {
    const dbClient = req.dbClient;
 ...
 */
router.get('/groups', validate(naceGroupsQuerySchema, 'query'), asyncHandler(async (req, res) => {
    const dbClient = req.dbClient;
 ...
 */
router.get('/size-classes', asyncHandler(async (req, res) => {
    const dbClient = req.dbClient;
    const result = await dbClient.query(`
