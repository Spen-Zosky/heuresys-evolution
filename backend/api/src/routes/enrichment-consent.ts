...
function resolveEmployeeId(req: Request): string {
...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    const result = await req.dbClient!.query(
      `SELECT enrichment_consent_at, enrichment_consent_scope
       FROM employees
...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    const jobsResult = await req.dbClient!.query(
