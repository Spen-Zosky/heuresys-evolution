...
export class SkillClassificationService {
     ...
     */
    async getClassification(escoSkillId) {
     ...
     */
    async upsertClassification(escoSkillId, classification, classifiedBy) {
        const result = await pool.query(`
     ...
     */
    async validateClassification(classificationId, validatedBy, updates) {
        const result = await pool.query(`
     ...
     */
    async getSkillsInCluster(clusterId) {
        const result = await pool.query(`
     ...
     */
    async assignToCluster(escoSkillId, clusterId) {
        await pool.query(`
     ...
     */
    async suggestCluster(escoSkillId) {
     ...
     */
    async getSkillsByCognitiveLevel(level) {
        const result = await pool.query(`
      SELECT
        es.*,
        sc.primary_category,
     ...
     */
    async getSkillsByTransferability(transferability) {
        const result = await pool.query(`
      SELECT
        es.*,
        sc.primary_category,
...
//# sourceMappingURL=skill-classification.js.map