 ...
 */
export function getScopeCondition(req, tableAlias) {
 ...
 * ```
 */
export function getNextParamIndex(scope) {
 ...
 * ```
 */
export function mergeScopeWith(scope, additionalWhere, additionalParams) {
 ...
 */
function prefixColumnsInWhere(where, prefix) {
